...
class YTChannel:
    def __init__(
        self,
        auth_opts: Optional[dict] = None,
        auth_opts_provider: Optional[Callable[[], dict]] = None,
        settings: Optional[Union[CoreSettings, dict]] = None,
        proxy_url: Optional[str] = None,
        requests_proxies: Optional[dict] = None,
    ...
    def _emit_error(self, message: str) -> None:
        ...
        try:
            ...
            self.logger.exception("Error callback failed: %s", message)
    ...
    def _get_auth_params(self):
        ...
        if self.auth_opts_provider:
            try:
                ...
                self.logger.exception("Auth provider failed; proceeding without auth opts")
                opts = {}
        elif self.auth_opts:
    ...
    def retrieve_video_metadata(self, video_url):
        ...
        try:
            ...
            self._emit_error(f"Failed to fetch video metadata: {e}")
            raise
    ...
    def _emit_invalid_playlist_error(self):
        self._emit_error("The URL is incorrect or unreachable.")
